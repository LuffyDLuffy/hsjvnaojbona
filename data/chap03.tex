...
\begin{equation}
    \Delta E_{\rm{A}}=0,\ -W_{\rm{A}}=Q_{\rm{A}} = \beta_{\rm{h}}^{-1} \int_{0}^{t_1} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)
    \label{eq3.16}
\end{equation}
...
\begin{equation}
    \Delta E_{\rm{C}}=0,\ -W_{\rm{C}}=Q_{\rm{C}} = \beta_{\rm{c}}^{-1} \int_{t_2}^{t_3} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)
    \label{eq3.18}
\end{equation}
...
\begin{table}[!htbp]
    ...
    过程  & 能量差  & 输入功     & 吸收热 \\ 
    \hline
    A    & 0       & $-\beta_{\rm{h}}^{-1} \int_{0}^{t_1} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)$                    &$\beta_{\rm{h}}^{-1} \int_{0}^{t_1} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)$     \\ 
    \hline
    B    & $(\beta_{\rm{c}}^{-1} - \beta_{\rm{h}}^{-1})$ & $(\beta_{\rm{c}}^{-1} - \beta_{\rm{h}}^{-1})$ & 0   \\ 
    \hline
    C    & 0       & $-\beta_{\rm{c}}^{-1} \int_{t_2}^{t_3} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)$                    &$\beta_{\rm{c}}^{-1} \int_{t_2}^{t_3} \mathrm{d} t \left( \frac{\dot{\lambda}}{ \lambda}  -\gamma \dot{\lambda}^2 \right)$     \\ 
    \hline
